...
public class MentorController {
	...
	/*
	 * @GetMapping("/mentors")
	 * public @ResponseBody ResponseEntity<List<User>>
	 * mentorList(@AuthenticationPrincipal PrincipalDetail principalDetail) {
	 * List<User>
	 * mainuserlist=userRepository.MentorFindByTeachSector(principalDetail.
	 * getTeachSector());
	 * List<User>
	 * userlist=userRepository.MentorFindByNotTeachSector(principalDetail.
	 * getTeachSector());
	 * 
